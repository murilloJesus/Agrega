				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="row">
							...
							<div class="form-group">
								...
								<select id="OfertaEstadoOrigem" name="data[Oferta][estado_origem]" class="form-control">
									<?php foreach ($estados as $value) 
											echo "<option value='".$value['Estado']['id']."'' data-uf='".$value['Estado']['UF']."' >".$value['Estado']['nome']."</option>";				
									?>
								</select>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<span class="required" aria-required="true">*</span>	
								<select id="OfertaEstadoDestino" name="data[Oferta][estado_destino]" class="form-control">
									<?php foreach ($estados as $value) 
											echo "<option value='".$value['Estado']['id']."'' data-uf='".$value['Estado']['UF']."' >".$value['Estado']['nome']."</option>";				
									?>
								</select>							
					...
					<div class="row">
							...
							<div class="form-group">
								...
								<span class="required" aria-required="true">*</span>	
								<select id="OfertaEstadoDestino" name="data[Oferta][estado_destino]" class="form-control selectpicker form-control" data-none-selected-text="Selecione o Municipio" data-live-search="true">
									<?php foreach ($municipios as $value) 
											echo "<option value='".$value['Municipio']['id']."'' data-tokens='".$value['Municipio']['nome']." ".$value['Municipio']['Uf']." ".$value['Municipio']['codigo']."' data-uf='".$value['Municipio']['Uf']."' >".$value['Municipio']['nome']."</option>";				
									?>
								</select>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<?php echo $this->Form->date('data_origem',
									array(
									'class'=>'form-control',
									'type'=>'date',
									'dateFormat' => 'DMY',
						...
						<div class="col-md-3">
							<div class="form-group">
								<label class="control-label">Hora Solicitação</label>
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-clock-o"></i>
									</span>
									<?php echo $this->Form->date('hora_origem',
												array(
												'class'=>'form-control',
												'type'=>'text',
												)
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<?php echo $this->Form->input('doc_transporte', array('type' => 'text'));?>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<?php echo $this->Form->input('valor_carga', array('type' => 'text'));?>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<?php echo $this->Form->input('valor_frete', array('type' => 'text'));?>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<label class="control-label">Previsão Carregamento</label>
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-calendar"></i>
									</span>
									<?php echo $this->Form->date('prev_carregamento',
													array(
													'class'=>'form-control',
													'type'=>'date',
													'dateFormat' => 'DMY',
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<?php echo $this->Form->date('data_saida',
													array(
													'class'=>'form-control',
													'type'=>'date',
													'dateFormat' => 'DMY',
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<?php echo $this->Form->input('hora_saida',
												array(
												'class'=>'form-control',
												'type'=>'text',
												)
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<?php echo $this->Form->date('data_chegada',
													array(
													'class'=>'form-control',
													'type'=>'date',
													'dateFormat' => 'DMY',
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<?php echo $this->Form->input('hora_chegada',
												array(
												'class'=>'form-control',
												'type'=>'text',
												)
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<label class="control-label">CTE</label>

								<?php echo $this->Form->input('cte');?>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<label class="control-label">Tempo de Patio</label>

								<?php echo $this->Form->input('tempo_patio');?>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<span class="required" aria-required="true">*</span>
								<?php echo $this->Form->input('aging');?>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<span class="required" aria-required="true">*</span>
								<?php echo $this->Form->input('cpf_motorista');?>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<span class="required" aria-required="true">*</span>
								<?php echo $this->Form->input('telefone_veiculo');?>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<span class="required" aria-required="true">*</span>
								<?php echo $this->Form->input('proprietario_veiculo');?>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">Meio de Captação</label>
								<span class="required" aria-required="true">*</span>
								<?php echo $this->Form->input('capitacao');?>
							</div>
						</div>
					</div>
